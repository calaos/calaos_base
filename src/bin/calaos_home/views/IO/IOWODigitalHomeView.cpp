...
IOWODigitalHomeView::IOWODigitalHomeView(Evas *_evas, Evas_Object *_parent, IOBase *_io, string style_addition, Elm_Genlist_Item_Type flags):
        GenlistItemBase(_evas, _parent, string("WODigital_") + style_addition, flags),
        IOBaseElement(_io)
{
}
