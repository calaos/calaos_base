        ...
        BaseView(e, parent)
{
        ...
        {
                Utils::logger("root") << Priority::CRIT << "PagingView: Can't load edje" << log4cpp::eol;
                throw;
        }
...
int PagingView::addPage(Evas_Object *content)
{
        ...
        {
                Utils::logger("root") << Priority::CRIT << "PagingView: Can't load edje calaos/paging_view/selector" << log4cpp::eol;
                throw;
        }
...
void PagingView::delPage(int page)
{
        ...
        {
                Utils::logger("root") << Priority::CRIT << "PagingView: delPage(" << page << ") out of bound [size: " << pages.size() << "] !" << log4cpp::eol;
                return;
        }
