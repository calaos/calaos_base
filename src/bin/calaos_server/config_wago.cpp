...
int main(int argc, char **argv)
{
        ...
        int address;
        string type;
        int addr1, addr2, sameas;
        stringstream s;
        string file, ip, boolean;
        int dali_line, dali_group, dali_addr, dali_value, dali_fade, dali_time, dali_group2;
        int dali_faderate, dali_fadetime, dali_maxlevel, dali_minlevel, dali_systemfailurelevel, dali_poweronlevel;
