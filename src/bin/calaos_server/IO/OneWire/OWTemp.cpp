    ...
    InputTemp(p)
{
    ...
    ioDoc->paramAdd("ow_id", "Unique ID of sensor on OneWire bus.", IODoc::TYPE_STRING, true);
    ...
    ioDoc->paramAdd("use_w1", "Force the use of w1 kernel driver instead of OneWire driver", IODoc::TYPE_BOOL, false);
