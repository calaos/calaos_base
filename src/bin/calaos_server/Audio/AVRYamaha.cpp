        ...
        AVReceiver(p, 50000)
{
        ...
        Utils::logger("output") << Priority::INFO << "AVRYamaha::AVRYamaha(" << params["host"] << "): Ok" << log4cpp::eol;
}

AVRYamaha::~AVRYamaha()
{
        Utils::logger("output") << Priority::INFO << "AVRYamaha::~AVRYamaha(): Ok" << log4cpp::eol;
}
...
{
        Utils::logger("output") << Priority::DEBUG << "AVRYamaha::processMessage(): Recv: " << msg << log4cpp::eol;
